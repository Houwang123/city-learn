from agents.marlisa.common.preprocessing import *
from agents.marlisa.common.rl import *
    ...
    def __init__(self, building_ids, 
        ...
        for uid in building_ids:
            ...
            if self.information_sharing:
                # print(len(self.observation_spaces[uid].low))
                # print(len(self.encoder[uid]))
